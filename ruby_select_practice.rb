...
def less_than20(numbers_array)
  numbers_less_than20 = numbers_array.select do |number|
    number < 20
  end
  numbers_less_than20
end

p less_than20([2, 32, 80, 18, 12, 3])
p less_than20([-1, 0, 44, 7, 19])
p less_than20([22, 100, 4, 67])
p less_than20([0, 2, 34, 5, -7])
